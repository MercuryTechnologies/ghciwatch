...
CABAL_REPL ?= $(CABAL) \
	...
	v2-repl $(CABAL_TARGET)

GHCIWATCH_OPTS ?=
# NB: This path is relative to the `Makefile`s that _include_ this file (in
# subdirectories), not relative to this file.
